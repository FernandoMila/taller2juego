...
=======
    public List<Ciudad> obtenerTodasLasCiudades() {
        ...
        ciudades.add(new Ciudad(1, "Colonia del Sacramento", "Descripción de Colonia del Sacramento", "imagenes/Ciudades/Colonia.jpg", 158, 480));
        ciudades.add(new Ciudad(2, "Montevideo", "Descripción de Montevideo", "imagenes/Ciudades/Montevideo.jpg",360, 515));
